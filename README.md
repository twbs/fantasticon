![Logo](https://github.com/ernstc/fantasticon/blob/dev/.github/logo.png)

<h2 align="center">Fantasticon</h2>

![Screenshot](https://github.com/ernstc/fantasticon/blob/dev/.github/screenshot.png)
...
<p align="center">
  <a href="https://github.com/ernstc/fantasticon/pkgs/npm/fantasticon">
    <img src="https://img.shields.io/github/v/release/ernstc/fantasticon?label=package&logo=github" alt="package version">
  </a>
  <a href="https://github.com/ernstc/fantasticon/actions/workflows/ci.yml?query=branch%3Adev">
    <img src="https://img.shields.io/github/actions/workflow/status/ernstc/fantasticon/ci.yml?branch=dev&label=CI&logo=github" alt="CI status">
  </a>
</p>
...
```bash
npm install -g @ernstc/fantasticon
```
...
```js
import { generateFonts } from '@ernstc/fantasticon';
